...
async function main(){
    const playback=(track) => {
        currentsong.src ="/learn3/learn4/website/learn6/srihas/spotify/songs/"+ track
        currentsong.play()
        sri21.src="pause.png"
...
console.log(t)
        for (const  song of songs) {
            t.innerHTML=t.innerHTML+`<li> <div class="sri10"><img src="musical-note.png" alt=""><span class="sri12">${song}</span> <span class="sri11">Play now</span><img src="play.png" alt=""></div></li>`;
        }
